                    ...
                    <div class="md-card">
                        <div class="md-card-content">
                            ...
                            <div class="uk-grid" data-uk-grid-margin="">
                                ...
                                <div class="uk-width-large-1-3 uk-width-medium-1-1">
                                    <button type="submit" class="md-btn md-btn-primary md-btn-block md-btn-wave-light waves-effect waves-button waves-light">GENERATE REPORT</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <table id="dt_report" class="uk-table" cellspacing="0" width="100%">
                        ...
                        @foreach($orders as $order)
                            <tr>
                                ...
                                <td>{{ $order->pin->sno }}</td>
                                <td>{{ $order->invoice->payment_type }}</td>
