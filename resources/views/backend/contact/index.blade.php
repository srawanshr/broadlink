...
@section('content')
    <div id="page_content">
        <div id="page_content_inner">
            ...
            <h3 class="heading_b uk-margin-bottom">All Contacts</h3>

            <div class="md-card">
                <div class="md-card-content">
                    <div id="contact_crud"></div>
                </div>
            </div>
    ...
    <div class="md-fab-wrapper">
        <a class="md-fab md-fab-accent" href="#" id="recordAdd" data-uk-tooltip="{pos:'left'}" title="Create Contact">
...
@push('scripts')
    ...
    @include('backend.contact.partials.table-script')
@endpush